...
![](imagenes/pull-request.svg){fig-alt="Un Pull Request muestra la rama, los commits, los archivos cambiados y el botón de fusión que pulsa otro integrante del equipo"}

## El ciclo completo

![](imagenes/git-flujo-pull-request.svg){fig-alt="Flujo en dos carriles: creas la rama, commiteas y publicas; en GitHub abres el Pull Request, el equipo lo revisa y lo fusiona"}
...
- Equipos de dos o tres, formados hoy en clase: el mismo equipo hasta la Semana 17.
- El proyecto nace con `flutter create <nombre>`, nunca continuando `hola_iue`.
- El nombre sale de la idea real que el equipo acaba de escribir en `docs/alcance.md`.

. . .

`hola_iue` sigue siendo tu ejercicio de práctica de la Semana 2. El proyecto del semestre arranca
de cero, con tu equipo.
...
- Abran `docs/alcance.md` y completen las cinco partes entre todos los integrantes.
- Si terminan antes, revisen que cada funcionalidad mínima sea alcanzable con lo que ya saben de
  Flutter.
...
- Apliquen el flujo completo en el proyecto del equipo: ramas, commits con mensaje, fusión revisada
  por otro integrante.
...
[Entreguen el enlace del repositorio del equipo por el canal de actividades.]{.grande}
