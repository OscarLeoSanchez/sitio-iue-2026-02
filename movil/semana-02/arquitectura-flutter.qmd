...
::: {.acceso}
Diapositivas de esta guía

[Abrir las diapositivas](presentacion-arquitectura-flutter.qmd){.btn-doc target="_blank"}
:::
...
Ya viste cómo separar estado (`State`) de configuración (`Widget`) resuelve el problema de que un
widget inmutable no puede cambiar por sí mismo. Falta ver cuándo ocurre cada paso de ese ciclo.
...
incremental, y esa es la base técnica de la recarga en caliente que ya usaste en la Semana 02:
