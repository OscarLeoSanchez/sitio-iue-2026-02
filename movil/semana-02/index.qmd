...
Las versiones que usa esta guía son las que quedaron instaladas y verificadas la semana pasada con
`flutter doctor`:
...
terminal para confirmar que sigue instalado desde la semana pasada:
...
Con las extensiones **Flutter** y **Dart** instaladas en VS Code (las instalaste en la Semana 1)
...
Con el emulador Android que dejaste listo en la Semana 1 abierto, aparece una cuarta línea con su
...
activada (la revisaste en la Semana 1).
...
El pacto de esta semana pide que Dart y la asincronía queden dominados, y que tu app reaccione a
